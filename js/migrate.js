    ...
    function normalizeForStorage(appData,prefsData={},ledgerRows=[]){
      ...
      const tables={app_meta:[],prefs:[],tags:[],message_kinds:[],members:[],rooms:[],room_members:[],messages:[],assets:[],polls:[],poll_options:[],poll_votes:[],handoff_notes:[],fronting_logs:[],tasks:[],system_profile:[],member_relations:[],external_system_cards:[],ledger_records:[]};
    ...
    function compareMigrationRoundTrip(original,restored){
      ...
      ["tags","messageKinds","members","rooms","messages","polls","handoffNotes","frontingLogs","tasks","systemProfile","memberRelations","externalSystemCards"].forEach(k=>walk(left.data[k],right.data[k],`data.${k}`));
