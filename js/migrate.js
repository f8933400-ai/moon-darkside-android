    ...
    function compareMigrationRoundTrip(original,restored){
      ...
      ["tags","messageKinds","members","rooms","messages","polls","handoffNotes","frontingLogs","tasks","systemProfile","systemProfileVisibility","memberRelations","externalSystemCards"].forEach(k=>walk(left.data[k],right.data[k],`data.${k}`));
