...
<p>
  <a href="#gray-test-warning">灰度提示</a> ·
...
<a id="gray-test-warning"></a>

## 先看这里：灰度测试免责声明

> **这是一个个人维护的灰度测试项目。**
>
> 很多功能已经能用，但仍可能在不同 Android 设备、浏览器内核、系统文件选择器、软键盘、后台恢复、长截图或大图片 / 大备份场景下出现兼容性问题。
>
...
>
> 本项目不是医疗器械，也不用于诊断、治疗、监测、预防任何疾病或精神健康状况。应用里的记录、搜索、统计、时间线回顾、照护板、任务、投票和任何自动整理结果，都只用于个人记录与沟通辅助，不构成医疗建议、心理咨询、风险评估、诊断意见或治疗方案，也不能替代医生、心理咨询师、治疗师、急救人员或其他专业人士的判断。
>
> 本项目无法识别、预测或处理自伤、伤人、失控、解离危机、药物风险、现实安全风险或其他紧急情况。不要依赖它来决定是否就医、是否停药 / 换药、是否延迟求助，或是否处于安全状态。
>
